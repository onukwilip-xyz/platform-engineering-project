...
dependency "cloud_armor" {
  ...
  enabled = local.env.ddos_protection == "cloud-armor"
...
inputs = {
  ...
  cloud_armor_security_policy_name = local.env.ddos_protection == "cloud-armor" ? dependency.cloud_armor.outputs.security_policy_name : ""
